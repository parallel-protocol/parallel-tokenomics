...
/// @notice sPRL2V2 is a staking contract that allows users to deposit PRL and WETH into a Balancer V3 pool.
/// The BPT is held by the contract.
contract sPRL2V2 is TimeLockPenaltyERC20 {
    ...
    /// @notice Constructor for the sPRL2V2 contract.
    ...
    constructor(
        ...
        TimeLockPenaltyERC20(
            NAME,
            SYMBOL,
            address(_configParams.balancerBPT),
            _feeReceiver,
            _accessManager,
    ...
    /// @notice Deposit BPT and mint the equivalent amount of sPRL2V2.
    ...
    function withdrawBPT(uint256[] calldata _requestIds, uint256 _maxAcceptablePenalty) external nonReentrant {
        ...
        if (totalBptAmountSlashed > 0) {
            BPT.safeTransfer(feeReceiver, totalBptAmountSlashed);
        }
